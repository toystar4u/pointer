...
sudo /usr/bin/socat -u udp-listen:10007,fork /dev/ttyUSB0,b115200,raw,echo=0 &       # USB-to-RS232 gender RTCM output
...
#sudo /usr/bin/socat -u tcp-listen:5555,reuseaddr,fork upd:localhost:10004 &     # OSR input 
